...
def training(train_x, train_y, valid_x=None, valid_y=None, format_size=[224, 224],
    ...
    with graph.as_default():
        ...
        logits = vgg16(train_maps, num_classes, isTrain=True, keep_prob=1.0)
    ...
    with tf.Session(graph=graph) as session:
        ...
        for epoch in range(num_epochs):
            for step in range(num_steps):
                ...
                #     print('Epoch %2d/%2d step %2d/%2d: ' % (epoch, num_epochs, step, num_steps))
            ...
            print ('Epoch %2d/%2d:\n\tTrain Loss = %.2f\t Accuracy = %.2f%%' %
                   (epoch, num_epochs, l, accuracy(predictions, batch_labels)))
...
if __name__ == '__main__':
    ...
    training(tr_x[::10, :, :, :], tr_y_onehot[::10, :],
             ...
             format_size=[32, 32], batch_size=50, learn_rate=0.1, num_epochs=30)
